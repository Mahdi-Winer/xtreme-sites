...
// Load product info (GET or after success)
if ($_SERVER['REQUEST_METHOD'] !== 'POST' || $success) {
    $api_url = 'https://api.xtremedev.co/endpoints/admin/get_product.php?id=' . $product_id;
    ...
    foreach($allowed_langs as $l) {
        $translations[$l]['name'] = $product['translations'][$l]['name'] ?? '';
        $translations[$l]['description'] = $product['translations'][$l]['description'] ?? '';
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $api_url = 'https://api.xtremedev.co/endpoints/admin/edit_product.php';
        $postdata = [
            'id' => $product_id,
...
<head>
    <meta charset="UTF-8">
    <title>Edit Product | XtremeDev Admin</title>
...
<div class="container-main">
    ...
    <div class="product-form-box">
        <?php if($success): ?>
            <div class="alert alert-success mb-3">Product successfully updated!</div>
        <?php elseif($errors): ?>
