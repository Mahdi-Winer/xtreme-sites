...
// زبان را فقط از ALLOWED_LANGS و DEFAULT_LANG بگیر
...
<head>
    <meta charset="UTF-8">
    <title id="site-title"><?= $translations['articles_and_news'] ?? 'Articles & News' ?></title>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var apiUrl = "https://api.xtremedev.co/endpoints/articles_get.php?id=" + encodeURIComponent(id) + "&lang=" + encodeURIComponent(lang);
    fetch(apiUrl)
        .then(function(res) {
        ...
        .then(function(art) {
            // نمایش ریسپانس API در کنسول
            console.log('Article API result:', art);
            ...
            backBtn.href = "articles.php";
            backBtn.className = "back-to-articles";
            backBtn.textContent = t['back_to_articles'] || '';
